...
import logoescuela from './escuelaing.png';
...
export default function ListaServicios() {
    ...
    function handleClick4(e) {
        e.preventDefault();
        window.open("https://tycho.escuelaing.edu.co/contenido/asignaturas-pregrado/12-dept-humanidades.pdf");
    }
    function handleClick9(e) {
        e.preventDefault();
        window.open("http://campusvirtual.escuelaing.edu.co/moodle/");
    }
    function handleClick10(e) {
        e.preventDefault();
        window.open("https://catalogo.escuelaing.edu.co/");
    }
            ...
            <main style={fondo}> 
                    ...
                    <Container maxWidth="sm" style={contenedor}>
                        <div className={classes.heroButtons}>
                            <Grid container spacing={2} style={carta} widht="200px">

                                <Grid item>
                                    <Button variant="contained" style={boton} color="secondary" onClick={handleClick}>
                                       
                                        <div className ="content" height="200px" widht="170px">
                            ...
                            <Grid container spacing={2} justify="center">
                                <Grid item>
                                    ...
                                    <div className ="content" height="200px" widht="170px">
                                        ...
                                        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 8.64 8.64"  enableBackground="new 0 0 8.64 8.64" width="110px" height="90px">
  <g>
    <g>
      <path d="m5.76,4.091h-1.2v-2.4c0-0.132-0.107-0.24-0.24-0.24-0.133,0-0.24,0.107-0.24,0.24v2.64c0,0.133 0.107,0.24 0.24,0.24h1.44c0.133,0.001 0.24-0.107 0.24-0.239s-0.107-0.241-0.24-0.241zm-3.607-3.592v-1.11022e-16c0.001,0.002 0.003,0.003 0.004,0.004l-.004-.004zm-1.324,1.328c-0.209-0.126-0.35-0.353-0.35-0.616 0-0.397 0.321-0.72 0.717-0.72 0.262,0 0.488,0.142 0.614,0.352l.343-.344c-0.218-0.294-0.564-0.487-0.957-0.487-0.66-1.04083e-17-1.196,0.537-1.196,1.199 0,0.395 0.192,0.742 0.485,0.96l.344-.344zm6.615-1.815c-0.396-1.04083e-17-0.744,0.195-0.961,0.492l.004-.004 .343,.344c0.125-0.21 0.352-0.352 0.614-0.352 0.396,0 0.717,0.322 0.717,0.72 0,0.263-0.141,0.49-0.351,0.616l.344,.345c0.294-0.22 0.486-0.567 0.486-0.962 0-0.662-0.536-1.199-1.196-1.199zm-3.124,.48c-2.121,0-3.84,1.719-3.84,3.84 0,1.18 0.533,2.234 1.371,2.938l-.965,.965c-0.09,0.09-0.09,0.236 0,0.326 0.09,0.09 0.236,0.09 0.326,0l.977-.977c0.012-0.013 0.018-0.027 0.027-0.041 0.605,0.396 1.327,0.628 2.104,0.628 0.764,0 1.473-0.225 2.071-0.609 0.005,0.007 0.008,0.015 0.014,0.021l.978,.977c0.09,0.09 0.236,0.09 0.326,0 0.09-0.09 0.09-0.236 0-0.326l-.943-.942c0.851-0.705 1.394-1.769 1.394-2.96 0-2.122-1.719-3.84-3.84-3.84zm0,7.2c-1.856,0-3.36-1.505-3.36-3.36 0-1.856 1.504-3.36 3.36-3.36 1.855,0 3.36,1.504 3.36,3.36 0,1.855-1.504,3.36-3.36,3.36z"/>
                    ...
                    <Container maxWidth="sm" style={contenedor}>
                        <div className={classes.heroButtons}>
                            <Grid container spacing={2} justify="center">
                                <Grid item>
                                    <Button variant="contained" style={boton6} color="secondary" onClick={handleClick9}>
                                    <div className ="content" height="200px" widht="170px">
                                        <span style={texto} >Campus Virtual</span>
                                        <svg id="Layer_1" enableBackground="new 0 0 110 110" height="110" viewBox="0 0 512 512" width="110" xmlns="http://www.w3.org/2000/svg"><g><path d="m497 30h-482c-8.284 0-15 6.716-15 15v343c0 8.284 6.716 15 15 15h151v49h-37c-8.284 0-15 6.716-15 15s6.716 15 15 15h254c8.284 0 15-6.716 15-15s-6.716-15-15-15h-37v-49h151c8.284 0 15-6.716 15-15v-343c0-8.284-6.716-15-15-15zm-181 422h-120v-49h120zm166-79h-452v-313h452z"/><path d="m133.112 174.073c-6.252-5.438-15.726-4.776-21.162 1.475l-11.132 12.8c-6.021-5.058-15.018-4.615-20.508 1.161-5.708 6.004-5.467 15.499.537 21.207l10.685 10.157c2.794 2.656 6.497 4.128 10.334 4.128.237 0 .475-.006.712-.017 4.089-.194 7.921-2.051 10.607-5.14l21.402-24.609c5.437-6.252 4.776-15.726-1.475-21.162z"/><path d="m105 343c24.813 0 45-20.187 45-45s-20.187-45-45-45-45 20.187-45 45 20.187 45 45 45zm0-60c8.271 0 15 6.729 15 15s-6.729 15-15 15-15-6.729-15-15 6.729-15 15-15z"/><path d="m91.532 137.981c2.794 2.657 6.497 4.129 10.334 4.129.236 0 .474-.006.711-.017 4.089-.194 7.921-2.051 10.607-5.14l21.402-24.609c5.437-6.251 4.776-15.725-1.475-21.162-6.252-5.438-15.726-4.776-21.162 1.475l-11.132 12.799c-6.021-5.057-15.018-4.615-20.508 1.161-5.708 6.004-5.468 15.498.536 21.206z"/><path d="m203 129.805h234c8.284 0 15-6.716 15-15s-6.716-15-15-15h-234c-8.284 0-15 6.716-15 15s6.716 15 15 15z"/><path d="m203 212.696h234c8.284 0 15-6.716 15-15s-6.716-15-15-15h-234c-8.284 0-15 6.716-15 15s6.716 15 15 15z"/><path d="m203 313h234c8.284 0 15-6.716 15-15s-6.716-15-15-15h-234c-8.284 0-15 6.716-15 15s6.716 15 15 15z"/></g></svg>
                                        </div>
                                    </Button>
                                </Grid>
                            </Grid>
                    ...
                    <Container maxWidth="sm" style={contenedor}>
                        <div className={classes.heroButtons}>
                            <Grid container spacing={2} justify="center">
                                <Grid item>
                                    <Button variant="contained" style={boton7} color="secondary" onClick={handleClick10}>
                                    <div className ="content" height="200px" widht="170px">
                                        <span style={texto} >Biblioteca</span>
                                        <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"  x="0px" y="0px"
	...
	<g>
		<path d="M404.72,82.944c-0.027,0-0.054,0-0.08,0h0h-27.12v-9.28c0.146-3.673-2.23-6.974-5.76-8
			...
			c4.368,0.663,8.447-2.341,9.11-6.709c0.065-0.427,0.095-0.859,0.09-1.291V98.944h19.12L396.64,333.664z"/>
                            ...
                            <Container maxWidth="sm" style={cont}>
                    {/* End hero unit */}
